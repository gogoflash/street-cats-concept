...
package starling.animation
{
    ...
    public class Tween extends EventDispatcher implements IAnimatable
    {
		...
		public function chain(target:Object, time:Number, properties:Object):Tween
		{
			if (nextTween)
			{
				nextTween.chain(target, time, properties);
			}
			else
			{
				nextTween = TweenHelper.makeTween(target, time, properties);
			}
			return this;
		}
    }

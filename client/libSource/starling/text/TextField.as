...
package starling.text
{
    ...
    public class TextField extends DisplayObjectContainer
    {
		...
		private var _helperFormat:BingoTextFormat = new BingoTextFormat();
        ...
        private function updateText():void
        {
			...
			//Special html text case was removed to allow autosizing of htmlText. Html alignment in text is NOT SUPPORTED.
		...
		public function get helperFormat():BingoTextFormat
        {
			return _helperFormat;
		}
    }
}

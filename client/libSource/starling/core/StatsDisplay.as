...
package starling.core
{
    ...
    internal class StatsDisplay extends Sprite
    {
        ...
        public function StatsDisplay()
        {
            ...
            const height:Number   = supportsGpuMem ? 50 : 42;
        ...
        public function update():void
        {
			...
			var pingText:String = (gameManager.watchdogs.connectionWatchdog.pingValue != -1 ? gameManager.watchdogs.connectionWatchdog.pingValue.toString() : "?"); 

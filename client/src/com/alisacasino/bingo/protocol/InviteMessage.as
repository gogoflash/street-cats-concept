package com.alisacasino.bingo.protocol {
	...
	public dynamic final class InviteMessage extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const REQUEST_ID:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.alisacasino.bingo.protocol.InviteMessage.request_id", "requestId", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (request_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: InviteMessage.requestId cannot be set twice.');
					}
					++request_id$count;

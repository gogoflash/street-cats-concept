...
package com.alisacasino.bingo.controls
{
     ...
     */
    public class BingoTrueTypeCompositor implements ITextCompositor
    {
        // helpers
        ...
        public function BingoTrueTypeCompositor()
        { }
                                      ...
                                      format:TextFormat, options:TextOptions=null):void
        {
            ...
            var bitmapData:BitmapDataEx = renderText(width, height, text, format as BingoTextFormat, options);

            texture = Texture.fromBitmapData(bitmapData, false, false, bitmapData.scale, textureFormat);
            texture.root.onRestore = function():void
            {
                bitmapData = renderText(width, height, text, format as BingoTextFormat, options);
        ...
        private function renderText(width:Number, height:Number, text:String,
                                    format:BingoTextFormat, options:TextOptions):BitmapDataEx
        {
			...
			sNativeTextField.filters = format.nativeFilters;
            ...
            var bitmapWidth:int   = Math.ceil(textWidth)  + format.nativeTextExtraWidth;
            var bitmapHeight:int  = Math.ceil(textHeight) + format.nativeTextExtraHeight;
